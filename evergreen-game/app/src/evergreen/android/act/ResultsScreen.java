...
import android.evergreen.util.TypedValue;
...
import static evergreen.common.player.Config.LatestLogMessageIDSeen;
...
//                    if (trans.contains("Bus")) drawableLeftSide = R.drawable.ri_bus;
                ...
                case MessageReceivedFromPlayer:
                case MessageSentToPlayer: drawableLeftSide = R.drawable.ri_message; break;
                case SentPlayerResources:
                case ReceivedPlayerResources: drawableLeftSide = R.drawable.ri_gift; break;
                case foundPlayerSelfLol:
                case searchPlayerFailed:
